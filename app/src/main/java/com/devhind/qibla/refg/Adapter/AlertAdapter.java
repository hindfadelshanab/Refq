...
public class AlertAdapter extends RecyclerView.Adapter<AlertAdapter.TaskViewHolder> {

    private Activity context;
    private LayoutInflater inflater;
    private List<Alert> taskList;
    ...
    public AlertAdapter(Activity context, List<Alert> taskList, CreateTaskBottomSheetFragment.setRefreshListener setRefreshListener) {
    ...
    public TaskViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = inflater.inflate(R.layout.item_alert, viewGroup, false);
        return new TaskViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TaskViewHolder holder, int position) {
        Alert task = taskList.get(position);
        holder.title.setText(task.getEvent());
...
//        holder.options.setOnClickListener(view -> showPopUpMenu(view, position));
    ...
    public void showPopUpMenu(View view, int position) {
        final Alert task = taskList.get(position);
...
//        Dialog dialog = new Dialog(context, R.style.Theme_Refg);
