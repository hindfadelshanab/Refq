...
import com.devhind.qibla.refg.databinding.FragmentDoneOrderBinding;
...
public class DoneOrderFragment extends Fragment {
    ...
    FragmentDoneOrderBinding binding;
    ...
    private void getDoneOrder(String userId){
        ...
        database.collection(Constants.KEY_COLLECTION_ORDERS).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                binding.DoneOrderRc.setVisibility(View.VISIBLE);

                orderAdapter = new OrderAdapter(getActivity() ,orders , false ,false , true );
                binding.DoneOrderRc.setAdapter(orderAdapter);
                binding.DoneOrderRc.setLayoutManager(new LinearLayoutManager(getContext()));
